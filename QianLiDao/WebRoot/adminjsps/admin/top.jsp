...
<style type="text/css">
  ...
  <body style="background: #f96eae;color: #fff;">
  <h1 style="text-align: center; line-height: 30px; font-family: '华文行楷', sans-serif;">千里岛在线鲜花商城后台管理</h1>
<div style="line-height: 10px;">
	...
	<span style="padding-left:50px;">
		...
		<a href="<c:url value='/adminjsps/admin/book/main.jsp'/>">鲜花管理</a>
